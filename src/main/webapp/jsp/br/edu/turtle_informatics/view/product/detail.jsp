<%@page import="br.edu.turtle_informatics.model.Product"%>
...
<body class="a-aui_51744-c a-aui_57326-c a-aui_58736-c a-aui_72554-c a-aui_75278-t2 a-aui_accessibility_49860-c a-aui_attr_validations_1_51371-c a-aui_bolt_62845-c a-aui_decorate_77059-c a-aui_noopener_84118-c a-aui_ux_56217-c a-aui_ux_59374-c a-aui_ux_60000-c a-meter-animate"><img src="https://images-na.ssl-images-amazon.com/images/G/01/gno/sprites/nav-sprite-global_bluebeacon-1x_optimized._CB281044790_.png" style="display:none" alt="">
        <!-- Page content-->
    <div id="unrec-pageContent" class="a-section a-spacing-none"
        role="main" style="background-color: #232f3e">
        
        <div class="col-md-12">
            <div class="col-md-10" style="background-color: white;">

                <div style="display: inline-block;" class="col-md-6">
                    <img src="" style="height: 400px; width: 400px; margin: 25px">
                </div>
                <div class="col-md-6">
                    ...
                    <br> <br> <br> <br> <br> <span
                        ...
                        style="color: #f64e26"><c:out value="${ product.price }" /></span></span> <br>
                    <button class=" btn btn-info btn-lg"
                        style="background-color: #f64e26; width: 300px; margin-top: 160px; margin-left: 0px">
            ...
            <div class="col-md-10"
                style="background-color: white; margin-left: 219px;">

                <ul class="tab">
                    <li><a href="javascript:void(0)" class="tablinks"
                        onclick="openCity(event, 'Descricao')">Descricao</a></li>
                    <li><a href="javascript:void(0)" class="tablinks"
                        onclick="openCity(event, 'Especificacao')">Especificacao</a></li>
                </ul>

                <div id="Descricao" class="tabcontent" style="margin-bottom: 20px">
                    <h3>Descricao</h3>
                    <p><c:out value="${ product.description }" /></p>
                </div>
                <% String specification = ((Product) request.getAttribute("product")).getSpecification(); %>

                <div id="Especificacao" class="tabcontent"
